...
for line1 in Question_file:
    ...
    Scores_A=BM25_score(Ques1,file1,IDF, Doc_Avg_Len, Doc_Length)   ##### This is sum of top 5 max scores

    Ques2= Question + " " + Option_B
    Scores_B = BM25_score(Ques2, file1, IDF, Doc_Avg_Len, Doc_Length)  ##### This is sum of top 5 max scores

    Ques3 = Question + " " + Option_C
    Scores_C = BM25_score(Ques3, file1, IDF, Doc_Avg_Len, Doc_Length)   ##### This is sum of top 5 max scores

    Ques4 = Question + " " + Option_D
    Scores_D = BM25_score(Ques4, file1, IDF, Doc_Avg_Len, Doc_Length)   ##### This is sum of top 5 max scores
